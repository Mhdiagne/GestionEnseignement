...
const DetailSemestre_Module = (props) => {
    ...
    return (
        <div>
            <div className='same-line'>
                ...
                <center>
                    <h3 className="mb-3 mt-2 title-grid">Listes des Modules du Semestre</h3>
                </center>
            </div>
