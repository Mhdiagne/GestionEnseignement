...
const DetailClasses_Formation = (props) => {
    ...
    return (
        <div>
            <div className='same-line'>
                ...
                <center>
                    <h3 className="mb-3 mt-2 title-grid">Listes des Formations pour la filiere</h3>
                </center>
            </div>
