        ...
        return (
            <div>
                <div className='same-line'>
                    ...
                    <center>
                        <h3 className="mb-3 mt-2 title-grid">Listes des Salles d`un Batiment</h3>
                    </center>
                </div>
